...
app.post("/delete",function(req,res){
  ...
  const de=req.body.button;
  console.log(de);
  Post.findByIdAndRemove(de,function(err){
    if(!err)
    {
      res.redirect("/");
    }
